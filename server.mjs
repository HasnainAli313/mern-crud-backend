...
// const mongoUri = 'mongodb+srv://aliorakzai407:<webdeveloper>@cluster0.uwz8y.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'; // or use your MongoDB Atlas URI
